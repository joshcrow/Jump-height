...
> **Not part of Jump Height.** This is a separate project idea for the same
> hardware family (XIAO nRF52840 Sense), parked here so it is not lost. It
> shares no code with the jump tracker and nothing in this repo depends on it.
> Moved out of the repo root on 2026-08-23 for exactly that reason.
