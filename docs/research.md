...
| ±8 g (ESP32) / ±16 g (Sense, shipped same day, commit 1b2c337) | ±8 g remains a peak-severity ceiling on the ESP32/FireBeetle build only (detection unaffected either way); ±16 g is precedented and already shipped on the Sense | skateboard IMU work at [±16 g](https://pmc.ncbi.nlm.nih.gov/articles/PMC8384043/); water-ski landing study reports 26–104 g peaks (UNVERIFIED full text) |
