...
| **Nick's board / mount** | **F-One Pocket, bamboo, blue with black accent** (owner, 2026-09-15): full corduroy deck pad, three strap inserts, a flat un-padded section forward of the pad. Puck has only ever ridden in a **vest pocket**. A **WOO mount** (self-adhesive cradle + O-rings) was ordered 2026-09-15 for the nose flat — fit against the Hammond case is **unmeasured** until it arrives; see BUILD.md's shopping list. | this session, 2026-09-15 |
