...
| What firmware is on the OG? | **`src=5c80a436`** — matches the tree (`jump sync` 2026-09-07: "device is running THIS source tree"). Confirm with `stats`; never infer from a commit date. | live read, 2026-09-07 |
