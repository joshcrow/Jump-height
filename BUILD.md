...
| Multimeter *(optional on the FireBeetle, ~$10)* | To confirm battery polarity. **Not optional for the Sense build** — its JST pigtail is soldered by hand and JST polarity is not standardized ([`docs/solder.md`](docs/solder.md) §1). |
